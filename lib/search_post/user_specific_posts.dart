...
class UserSpecificPostsScreen extends StatefulWidget {
  ...
  UserSpecificPostsScreen(this.userId,this.userName);

  @override
  State<UserSpecificPostsScreen> createState() => _UserSpecificPostsScreenState();
}

class _UserSpecificPostsScreenState extends State<UserSpecificPostsScreen> {
